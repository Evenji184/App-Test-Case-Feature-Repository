...
export function FormDrawer({ open, title, onClose, onSubmit, submitText, children }: Props) {
  return (
    <Popup
      ...
      onClose={onClose}
      closeOnMaskClick
      bodyStyle={{ width: 'min(100vw, 480px)', height: '100dvh', display: 'flex', flexDirection: 'column' }}
    >
      ...
      <div style={{ padding: '0 16px calc(16px + env(safe-area-inset-bottom, 0px)) 16px', flexShrink: 0, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
